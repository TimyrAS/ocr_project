...
# Порог нечёткого матчинга прайс-листа (0.0 - 1.0)
PRICE_MATCH_THRESHOLD = 0.85

# Порог неоднозначности прайс-матчинга (разница между top-1 и top-2)
PRICE_AMBIGUITY_GAP = 0.02

# Допуск совпадения цены: max(PRICE_TOLERANCE_PCT * price, PRICE_TOLERANCE_ABS)
PRICE_TOLERANCE_PCT = 0.01
PRICE_TOLERANCE_ABS = 100
